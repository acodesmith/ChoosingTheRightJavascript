...
<div class="site-index">
    ...
    <div class="jumbotron">
        <h1>Choosing the right Javascript for the Job</h1>
    ...
    <div class="body-content">
        ...
        <div class="row">
            <div class="col-lg-4">
                ...
                <p>Backbone.js gives structure to web applications by providing models with key-value binding and custom events,
            ...
            <div class="col-lg-4">
                ...
                <p>AngularJS lets you extend HTML vocabulary for your application.
            ...
            <div class="col-lg-4">
                ...
                <p>Ember.js is an open-source client-side JavaScript web application framework based on the model-view-controller
